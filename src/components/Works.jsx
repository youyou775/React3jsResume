    ...
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      ...
      >
        <div className="relative w-full h-[230px]">
          ...
          <div className="absolute inset-0 flex justify-end m-3 card-img_hover">
            <div
              ...
              className="bg-primary-text w-10 h-10  rounded-full 
        ...
        <div className="mt-5">
          ...
          <p className="mt-2 text-primary-text text-[14px]">{description}</p>
        </div>
    ...
    <>
      ...
      <div className="w-full flex">
        <motion.p
          ...
          className="mt-3 text-primary-text text-[17px] max-w-3xl 
        leading-[30px] "
        >
